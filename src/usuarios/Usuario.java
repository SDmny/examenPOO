...
//Poner el metodo para cambiar RFC*******
    ...
    public String toString() {
        String cadena = String.format("Id: %d; Nombre completo: %s %s %s; Rol: %s; Nombre de usuario: %s, CURP: %s, RFC: %s, Dirección: %s, %s, %s", id, nombre, apellido1, apellido2, rol, usuario, curp, rfc, ciudad, estado, direccion);
        return cadena;
    }
    //  dateBirth
